...
var padArray = _interopDefault(require('ml-pad-array'));
...
function SavitzkyGolay(data, h, options) {
  ...
  if (
    ...
    var J = mlMatrix.Matrix.ones(options.windowSize, options.polynomial + 1);
    ...
    var Jtranspose = new mlMatrix.MatrixTransposeView(J);
    var Jinv = mlMatrix.inverse(Jtranspose.mmul(J));
